...
(function(G){'use strict';
 function executeCommand(document,command,target={},payload={}){
  ...
  try{
   ...
   return {ok:true,document:next,affectedIds:[target.trackId,target.patternId,target.clipId].filter(Boolean),changeKinds:['music'],changed:JSON.stringify(document)!==JSON.stringify(next)};
