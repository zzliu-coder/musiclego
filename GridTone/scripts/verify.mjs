...
const jobs=[['catalog',['scripts/catalog-build.mjs']],['build',['scripts/build.mjs']],['core',['--test',...tests]],...['storage','workflow','release-flow','interactions','closure','visual','audio'].map(name=>[name,['tests/verify-'+name+'.mjs']])];
